...
class company_serializer(serializers.Serializer):
    cid = serializers.CharField(max_length=100, allow_null=True, required=False)
    ...
    compCountryCode = serializers.CharField(max_length=10)
    ...
    bankCode = serializers.CharField(max_length=10, allow_null=True, required=False)
    ...
    compMediaPath = serializers.CharField(max_length=100, allow_null=True, required=False)
    compLogo = serializers.CharField(max_length=100, allow_null=True, required=False)
    compBrandLogo = serializers.CharField(max_length=100, allow_null=True, required=False)
    compDocLogo = serializers.CharField(max_length=100, allow_null=True, required=False)
    compMedia = serializers.CharField(max_length=100, allow_null=True, required=False)
    signImage = serializers.CharField(max_length=100, allow_null=True, required=False)
    #compDbName = serializers.CharField(max_length=155, allow_null=True, required=False)
    clientCode = serializers.CharField(max_length=10, allow_null=True, required=False)
    productCode = serializers.CharField(max_length=10, allow_null=True, required=False)
